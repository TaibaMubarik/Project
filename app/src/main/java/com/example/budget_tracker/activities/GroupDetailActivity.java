...
import com.example.budget_tracker.GMailSender;
import com.example.budget_tracker.adapters.AccountAdapter;
...
import com.example.budget_tracker.adapters.AccountAdapterGroupDetail;
import com.example.budget_tracker.models.Account;
import com.example.budget_tracker.models.Group;
import com.example.budget_tracker.models.Notification;
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        for (Account account : accounts) {
                            ...
                            if (account.isInternalAccount()) {
                                ...
                                message = "Hi! You owe " + amount + " for settlement of expenses of group : " + groupName;
                        ...
                        if (externalAccounts.size() > 0) {
                            ...
                            for (Account account : externalAccounts) {
                                ...
                                String subject = "Budget Tracker settlement detail for group: "+groupName;
                                String messageContentIndividual ="Hi "+ownerName+"! Your balance is "+amountForPerson+"  in group: "+groupName;
                                ...
                                String emailFrom = "budgettracker03@gmail.com";
                                String emailPass = "budgetamh3";
                            ...
                            if(numberOfSuccessfulSMS == externalAccounts.size()){
                                Toast.makeText(GroupDetailActivity.this, "Message SENT", Toast.LENGTH_SHORT).show();
                                finish();
                                startActivity(getIntent());
                            }

...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    public void saveExpense() {
        if (selectedDate == null) {
            ...
            tempDateS = selectedDate.toString();
            ProgressDialog dialog = new ProgressDialog(AddExpenseActivity.this);
            dialog.setMessage("Saving Expense..");
            dialog.show();
        }
        ...
        if (etTitle.getText().toString().trim().isEmpty() ||
            ...
            Expense expense = new Expense(groupName="Hi",title, amount, selectedCategory, buyerId, groupId,

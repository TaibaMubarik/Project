package com.example.budget_tracker.models;
...
public class Expense implements Serializable {
    ...
    public Expense(String name, String title, Double amount, String category, String payerAccountId, String groupId, String date,
